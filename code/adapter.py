"""
Modification of 'datalad-container/datalad_container/adapters/docker.py'
of Commit 67dfdc1a39df1952474ab0a00dc4e1f8e21dbf18

Changes:
Mounting freesurfer license file from 'CWD/licence.txt' to '/opt/freesurfer/license.txt'.
This is the default directory, freesurfer will look for. Therefore no --fs-license-file 
flag will be needed when running the fMRIPrep docker container.
"""
